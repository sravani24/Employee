    ...
    <form id="form1" runat="server">
        <div style="height: 709px; margin-bottom: 260px;">
            ...
            <asp:TextBox ID="TextBox2" runat="server" Width="182px" Height="16px"></asp:TextBox>
                ...
                &nbsp;<asp:DropDownList ID="DropDownList1" runat="server" Height="19px" Width="184px" Style="margin-left: 0px"  DataSourceID="SqlDataSource2" DataTextField="DepartmentName" DataValueField="DepartmentName" >
                </asp:DropDownList>
                ...
                &nbsp;&nbsp;<asp:TextBox ID="TextBox3" runat="server" Width="174px" Style="margin-left: 1px" MaxLength="10" minlength="10" Height="17px"></asp:TextBox>
                 <asp:RequiredFieldValidator
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DropDownList2" runat="server" Height="19px" Width="184px"  OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="StateName" DataValueField="StateName">
                </asp:DropDownList>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DropDownList3" runat="server" Height="19px" Width="181px" Style="margin-left: 0px">
                </asp:DropDownList>
                <asp:RequiredFieldValidator
